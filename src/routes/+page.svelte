...
<main class="flex flex-row text-white bg-primary">
	...
	<div class="flex flex-col items-center justify-center w-screen h-screen">
		<div class="flex flex-col items-center justify-center mb-10 space-y-5 rounded-2xl">
			<img
		...
		<div class="flex items-center justify-center">
			<a
				class="inline-flex items-center justify-center px-4 py-2 mr-2 text-black bg-white rounded hover:bg-white/80"
			...
			<a
				class="inline-flex items-center justify-center px-4 py-2 ml-2 text-white rounded bg-blurple hover:bg-blurple/80"
