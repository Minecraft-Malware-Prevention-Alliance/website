...
<main class="flex flex-row text-white bg-primary">
	...
	<div class="fixed inset-0 flex flex-col items-center justify-center w-screen h-screen">
		<div class="flex flex-col items-center justify-center mb-10 gap-y-5 rounded-2xl px-4">
			<img
		...
		<div class="flex items-center justify-center gap-x-4">
			<a
				class="inline-flex items-center justify-center px-4 py-2 gap-x-2 text-black bg-white rounded hover:bg-white/80 font-medium transition-colors"
			...
			<a
				class="inline-flex items-center justify-center px-4 py-2 gap-x-2 text-white rounded bg-blurple hover:bg-blurple/80 font-medium transition-colors"
