...
<main class="flex flex-row text-white bg-primary">
	...
	<div class="flex flex-col items-center justify-center w-screen h-screen">
		<div class="mb-10 space-y-5 rounded-2xl">
			<div class="flex items-center justify-center mb-6">
				<img src="/fmt-logo-chroma+glow.png" class="rounded-full" alt="MMPA Logo" height="192" width="192" />
			</div>
		...
		<div class="flex items-center justify-center">
			<a class="inline-flex items-center justify-center px-4 py-2 mr-2 text-black bg-white rounded hover:bg-white/80" href="https://github.com/Minecraft-Malware-Prevention-Alliance" target="_blank" rel="noopener noreferrer">
			...
			<a class="inline-flex items-center justify-center px-4 py-2 ml-2 text-white rounded bg-blurple hover:bg-blurple/80" href="https://discord.gg/zPdFK47682" target="_blank" rel="noopener noreferrer">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
